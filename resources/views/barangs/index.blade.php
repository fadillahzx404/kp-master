            ...
            <div class="title-table grid">
                <div class="flex justify-between">
                    <div class="grid place-content-center">
                        ...
                        <p class="text-sm font-light text-gray-400">Barang ada disini, anda bisa menambahkan, megedit atau
                            menghapus.
                        </p>
                    </div>
                                ...
                                <div class="modal" role="dialog">
                                    <div class="modal-box">
                                        ...
                                        <div class="modal-action">
                                            <label for="my_modal_6-{{ $data->id }}" class="btn">Close!</label>
                                        </div>
                                    </div>
                                </div>
                            </th>
